...
|---|---|---|
| `error` | Build-blocking issue | Sets `has_errors()` flag; blocks emit when `no_emit_on_error = true` |
...
| `TPY5002` | error | Emit blocked because `no_emit_on_error = true` and errors exist |
