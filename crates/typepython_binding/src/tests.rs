...
fn bind_marks_async_functions() {
    ...
    assert_eq!(table.declarations[0].callable_signature_text().as_deref(), Some("()->int"));
}
    ...
    assert_eq!(
        ...
        vec![
            GenericTypeParam {
                name: String::from("T"),
                kind: GenericTypeParamKind::TypeVar,
                bound_expr: Some(BoundTypeExpr::new("Comparable")),
                constraint_exprs: Vec::new(),
                default_expr: None,
            },
            GenericTypeParam {
                ...
                kind: GenericTypeParamKind::TypeVar,
                bound_expr: None,
                constraint_exprs: vec![BoundTypeExpr::new("int"), BoundTypeExpr::new("str")],
                default_expr: None,
            },
            GenericTypeParam {
                name: String::from("V"),
...
fn bind_formats_signature_with_positional_only_params() {
    ...
    assert_eq!(table.declarations.len(), 1);
    assert_eq!(
        table.declarations[0].callable_signature_text().as_deref(),
...
fn bind_collects_class_with_multiple_bases() {
    ...
    assert_eq!(
        table.declarations[0].rendered_class_bases(),
        vec![String::from("Base1"), String::from("Base2"), String::from("Mixin"),]
    );
}
