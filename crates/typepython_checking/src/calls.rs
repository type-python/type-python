...
pub(super) fn instantiate_direct_function_signature(
    signature: &[typepython_syntax::DirectFunctionParamSite],
...
pub(super) fn instantiate_direct_function_param(
...
#[allow(clippy::too_many_arguments)]
pub(super) fn bind_callable_param_spec_type_params(
    node: &typepython_graph::ModuleNode,
    nodes: &[typepython_graph::ModuleNode],
    annotation: &str,
    actual: &str,
...
pub(super) fn callable_param_expr_mentions_param_spec(
    params_expr: &str,
    param_spec_names: &BTreeSet<String>,
) -> bool {
...
pub(super) fn bind_callable_param_expr(
    node: &typepython_graph::ModuleNode,
    nodes: &[typepython_graph::ModuleNode],
...
pub(super) fn insert_param_spec_binding(
    substitutions: &mut GenericTypeParamSubstitutions,
    name: &str,
...
pub(super) fn resolve_callable_shape_from_actual(
    node: &typepython_graph::ModuleNode,
    nodes: &[typepython_graph::ModuleNode],
    actual: &str,
    actual_value: Option<&typepython_syntax::DirectExprMetadata>,
...
pub(super) fn resolve_callable_shape_from_metadata(
    node: &typepython_graph::ModuleNode,
    nodes: &[typepython_graph::ModuleNode],
...
pub(super) fn synthesize_param_list_binding(
...
pub(super) fn param_list_binding_from_default(default: &str) -> Option<ParamListBinding> {
...
pub(super) fn extract_param_spec_args_name(annotation: &str) -> Option<&str> {
    annotation.strip_suffix(".args").map(str::trim).filter(|name| !name.is_empty())
}

pub(super) fn extract_param_spec_kwargs_name(annotation: &str) -> Option<&str> {
    annotation.strip_suffix(".kwargs").map(str::trim).filter(|name| !name.is_empty())
}

pub(super) fn generic_type_param_accepts_actual(
    node: &typepython_graph::ModuleNode,
    nodes: &[typepython_graph::ModuleNode],
...
pub(super) fn bind_generic_type_params(
    node: &typepython_graph::ModuleNode,
    nodes: &[typepython_graph::ModuleNode],
    annotation: &str,
    actual: &str,
...
pub(super) fn infer_generic_type_param_bindings(
    node: &typepython_graph::ModuleNode,
    nodes: &[typepython_graph::ModuleNode],
    annotation: &str,
    actual: &str,
...
pub(super) fn combine_generic_substitutions(
...
pub(super) fn select_best_union_branch_binding(
...
pub(super) fn merge_union_branch_bindings(
    candidates: Vec<BTreeMap<String, String>>,
) -> Option<BTreeMap<String, String>> {
...
pub(super) fn merge_generic_type_candidates(existing: &str, actual: &str) -> String {
    if existing == actual {
        existing.to_owned()
    } else {
...
pub(super) fn substitute_type_substitutions(
    annotation: &str,
    substitutions: &BTreeMap<String, String>,
) -> String {
...
pub(super) fn substitute_generic_type_params(
    annotation: &str,
    substitutions: &GenericTypeParamSubstitutions,
) -> String {
...
pub(super) fn substitute_callable_param_expr(
    params_expr: &str,
    substitutions: &GenericTypeParamSubstitutions,
) -> String {
...
pub(super) fn render_param_list_binding_for_callable(
    binding: &ParamListBinding,
    substitutions: &GenericTypeParamSubstitutions,
) -> String {
