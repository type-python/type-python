...
repo-contracts:
	$(PYTHON) -m unittest scripts/test_repo_contracts.py scripts/test_downstream_checker_matrix.py scripts/test_research_roadmap_demo_smoke.py scripts/test_industrial_perf_smoke.py
